...
def clean_training_data():
    ...
    data_file = Path('/root/santhosh/trading/options/data/training/nse_fo_training_data.csv')
    output_file = Path('/root/santhosh/trading/options/data/training/nse_fo_training_data_clean.csv')
