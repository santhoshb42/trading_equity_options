...
class LiveDataTracker:
    ...
    def __init__(self):
        # BASE_DIR is typically /root/santhosh/trading/put_options
        # Use PUT-specific data directory (separate from CE bot)
        self.data_dir = Path('/root/santhosh/trading/put_options/data')
