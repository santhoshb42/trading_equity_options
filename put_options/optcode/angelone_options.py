...
class OptionChain:
    ...
    def get_atm_contracts(self, current_spot: float, offset: int = 0, contract_type: str = None) -> Optional[Tuple[OptionContract, OptionContract]]:
        """
        ...
        if contract_type == 'PE':
            ...
            logger.debug(f"ATM: CE_STRIKE | LTP={current_spot} | next_higher_strike={atm_strike} (OTM CALL) | available={available_strikes[:5]}...")
