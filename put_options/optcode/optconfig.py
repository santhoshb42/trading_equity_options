...
All AngelOne parameters, budget settings, and PE options-specific configuration.
Completely independent from CE options bot (port 8081), runs on port 8082.
Shares only webhook alerts stream from TradingView.
"""
...
class WebhookConfig:
    """Webhook configuration for PUT options alerts"""
    
    PORT = int(os.getenv("PUT_OPTIONS_WEBHOOK_PORT", "8082"))  # PUT options on 8082, CE options on 8081
    HOST = os.getenv("PUT_OPTIONS_WEBHOOK_HOST", "127.0.0.1")
