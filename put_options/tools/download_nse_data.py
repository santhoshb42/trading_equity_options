...
class NSEDataCollector:
    ...
    def __init__(self):
        self.output_dir = Path('/root/santhosh/trading/put_options/data/training')
...
Location: /root/santhosh/trading/put_options/data/training/real_trades_candles.csv
...
- Output: CSV files in /root/santhosh/trading/put_options/data/training/
