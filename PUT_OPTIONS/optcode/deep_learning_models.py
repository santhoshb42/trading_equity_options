...
from __future__ import annotations  # lazy annotation evaluation — keeps np.ndarray in signatures without importing numpy at load time
import json
...
class CNNPatternRecognizer:
    ...
    def identify_pattern(self, premium_series: np.ndarray) -> Dict[str, float]:  # noqa: F821
        """
