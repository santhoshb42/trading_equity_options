"""
PUT Options Trading Bot Configuration Module

Unified PE bot config. BOT_MODE=OTM (port 8082) or ITM (port 8083).
Completely independent from CE options bots (ports 8080/8081).
"""
...
# Runtime files live inside PUT_OPTIONS/OTM/ or PUT_OPTIONS/ITM/ (never shared)
...
class OptionsTradingConfig:
    ...
    MIN_CONFIDENCE_TREND_CONTINUATION = float(os.getenv("OPTIONS_MIN_CONFIDENCE_TREND_CONTINUATION", "75"))
    # PE-specific entry type confidence thresholds
    MIN_CONFIDENCE_PRE_FALL = float(os.getenv("OPTIONS_MIN_CONFIDENCE_PRE_FALL", "55"))
    MIN_CONFIDENCE_PULLUP = float(os.getenv("OPTIONS_MIN_CONFIDENCE_PULLUP", "60"))
    MIN_CONFIDENCE_MACD_BREAKDOWN = float(os.getenv("OPTIONS_MIN_CONFIDENCE_MACD_BREAKDOWN", "85"))
    MIN_CONFIDENCE_DEEP_MACD_BREAKDOWN = float(os.getenv("OPTIONS_MIN_CONFIDENCE_DEEP_MACD_BREAKDOWN", "65"))
    MIN_CONFIDENCE_MOMENTUM_BREAKDOWN = float(os.getenv("OPTIONS_MIN_CONFIDENCE_MOMENTUM_BREAKDOWN", "70"))
...
class WebhookConfig:
    ...
    PORT = int(os.getenv("PUT_OPTIONS_WEBHOOK_PORT", "8082"))  # OTM=8082, ITM=8083 via .env.{mode}
