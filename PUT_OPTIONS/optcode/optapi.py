...
def _process_options_alert(alert: Dict[str, Any], state: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        # Data 08-03..06: PUT bot's ENTIRE loss was 09:30-09:45 (-₹49.8K, WR 30%) —
        # short-CALLs get crushed by the morning up-drift, at ALL premium levels (not a
        # low-premium effect). The 09:45-10:00 window is the best (+₹6.9K, WR 77%).
        # Env-driven & default no-op (09:15); PUT .env sets 09:45. CE stays 09:15.
        ...
        # (e.g. GODREJPROP ₹71.25 vs strike*0.01=₹19, or LAURUSLABS refreshed to ₹47) is far from the
