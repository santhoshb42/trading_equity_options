...
def _process_options_alert(alert: Dict[str, Any], state: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        # as the cost basis is what produced the phantom +300% surges (LAURUSLABS fabricated ₹15.00
        # while the live LTP was ₹47). Always use the fresh broker LTP when present.
