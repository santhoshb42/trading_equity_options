"""
Options Bot Logging Module

Comprehensive debug logging for options trading operations.
...
from .optconfig import BASE_DIR, BOT_MODE

# =============================================================================
# Logging Configuration
# =============================================================================

# Create logs directory (mode-isolated so OTM and ITM logs don't mix)
...
class OptionsLogger:
    """Central logging for options bot"""
