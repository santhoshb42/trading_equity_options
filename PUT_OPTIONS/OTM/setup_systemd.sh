...
echo "      sudo journalctl -u put_optbot.service -n 50 -f"
echo ""
echo "   View all logs:"
echo "      sudo journalctl -u put_optbot.service --no-pager"
echo ""
echo "   Enable auto-start on boot:"
echo "      sudo systemctl enable put_optbot.service"
echo ""
echo "   Disable auto-start:"
echo "      sudo systemctl disable put_optbot.service"
echo ""
echo "   Watch watchdog logs:"
echo "      sudo journalctl -u put_optbot-watchdog.service -f"
echo ""
echo "   Check if auto-restart is enabled:"
echo "      sudo systemctl status put_optbot.service | grep 'Restart='  "
echo ""
echo "📊 HEALTH CHECK:"
echo ""
