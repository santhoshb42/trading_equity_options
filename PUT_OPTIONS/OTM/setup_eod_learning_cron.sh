...
CRON_JOB="30 15 * * 1-5 /root/santhosh/trading/put_options/run_eod_learning.sh"
...
echo "  Script: /root/santhosh/trading/put_options/run_eod_learning.sh"
echo "  Log: /root/santhosh/trading/put_options/logs/eod_learning.log"
echo ""
