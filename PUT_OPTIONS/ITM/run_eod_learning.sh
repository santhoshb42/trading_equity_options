...
#
# Usage: /root/santhosh/trading/ITM_put_options/run_eod_learning.sh
# Typically run via cron at market close (3:30 PM IST): 30 15 * * 1-5
################################################################################

LOG_FILE="/root/santhosh/trading/ITM_put_options/logs/eod_learning.log"
...
PNL_FILE="/root/santhosh/trading/ITM_put_options/data/option_pnl_history.json"
if [ ! -f "$PNL_FILE" ]; then
...
ARCHIVE_DIR="/root/santhosh/trading/ITM_put_options/data/archive"
...
python3 -c "
import sys
sys.path.insert(0, '/root/santhosh/trading/ITM_put_options/optcode')
