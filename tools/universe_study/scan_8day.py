...
Output: candidates_8day.json — one row per candidate bar with all features + label + leg-first flags.
"""
import json
import math
...
DAYS = ["2026-07-06","2026-07-07","2026-07-08","2026-07-09","2026-07-10","2026-07-13","2026-07-14","2026-07-15"]
...
def in_window(hhmm):
    return "09:30" <= hhmm <= "14:59"  # full-day sweep (label horizon truncates near close)
...
def main():
    ...
    candles = json.load(open(OUT / "candles10.json"))
    ...
    json.dump(all_rows, open(OUT / "candidates_8day.json", "w"))
