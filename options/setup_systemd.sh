#!/bin/bash
################################################################################
#                    OPTIONS BOT SYSTEMD SETUP SCRIPT
#
# This script sets up the options bot as a systemd service that:
...
echo "╔════════════════════════════════════════════════════════════════════════╗"
echo "║                  OPTIONS BOT - SYSTEMD SETUP                          ║"
echo "╚════════════════════════════════════════════════════════════════════════╝"
...
SERVICE_FILE="/etc/systemd/system/optbot.service"
WATCHDOG_SERVICE="/etc/systemd/system/optbot-watchdog.service"
...
systemctl enable optbot.service
echo "✅ optbot.service enabled (starts on boot)"

systemctl enable optbot-watchdog.service
echo "✅ optbot-watchdog.service enabled"

# Step 5: Display service status
echo ""
echo "Step 5: Service Status"
echo "─────────────────────────────────────────────────────"
systemctl status optbot.service --no-pager || echo "Service not running yet"
echo ""
...
echo ""
echo "   Start the bot:"
echo "      sudo systemctl start optbot.service"
echo ""
echo "   Stop the bot:"
echo "      sudo systemctl stop optbot.service"
echo ""
echo "   Restart the bot:"
echo "      sudo systemctl restart optbot.service"
echo ""
echo "   Check status:"
...
echo ""
echo "   Verify isolation from equity bot:"
echo "      netstat -tuln | grep -E ':(80|8081)'"
echo ""
echo "   View equity bot service:"
echo "      sudo systemctl status eqbot.service"
echo ""
...
echo "      sudo journalctl -u optbot.service -f"
echo ""
